        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Tạo Tin</a></li>
                        <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Danh Sách Tin</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-pie-chart"></i>
                        <span>Tin Nhà Nông</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-briefcase"></i> <span> Hỏi Đáp</span>
                    </a>
                </li>

                <li class="header"> </li>
                <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Đăng Xuất</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
